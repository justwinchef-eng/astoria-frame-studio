...
const Map = () => {
  ...
  const storeLat = 40.7470;
  const storeLng = -73.9188;
        ...
        .setPopup(
          new mapboxgl.Popup({ offset: 25 })
            .setHTML(
              ...
              '<a href="https://www.google.com/maps/dir/?api=1&destination=40.7470,-73.9188" target="_blank" style="color: #8B1538; text-decoration: underline;">Get Directions</a>'
            )
        )
        .addTo(map.current);
