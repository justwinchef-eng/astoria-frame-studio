...
const Map = () => {
  ...
  const storeLat = 40.7656156;
  const storeLng = -73.91887269;
        ...
        .setPopup(
          new mapboxgl.Popup({ offset: 25 })
            .setHTML(
              ...
              '<a href="https://www.google.com/maps/dir/?api=1&destination=34-04+30th+Ave+Astoria+NY+11103" target="_blank" style="color: #8B1538; text-decoration: underline;">Address: 34-04 30th Ave., Astoria, NY 11103</a>'
            )
        )
        .addTo(map.current);
